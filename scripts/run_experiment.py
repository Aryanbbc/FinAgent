...
def main() -> int:
    ...
    print(f"Trades / Year:      {_decimal(metrics['trades_per_year'])}")
    print(f"Avg Hold (bars):    {_decimal(metrics['average_holding_period_bars'])}")
    print(f"Position Changes:   {metrics['position_changes']}")
