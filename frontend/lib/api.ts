...
export const api = {
  health: () => request<{ status: "ok" | "degraded"; version: string; database_status: string; dataset_registry_status: string; latest_experiment_at: string | null; latest_validation_at: string | null }>("/api/health"),
